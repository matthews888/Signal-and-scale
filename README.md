...
The code is prepared on `careers-application-form`. Do not promote it to production until environment configuration and preview verification are complete.

1. The dedicated Neon database **signal-and-scale-careers** has been created on the existing free Vercel integration and connected to **signal-and-scale**, with database branching enabled for preview deployments.
